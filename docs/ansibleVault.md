...
| Stage | Name | Purpose |
|-------|------|---------|
| 0 | [**PRE**](#stage-0-pre-flight-checks) | Pre-flight checks: detect Vault state, validate required variables, verify cert/key pairs |
| 1 | [**INIT**](#stage-1-initialize-first-run-only) | Initialize Vault (only on first run) |
| 2 | [**UNSEAL**](#stage-2-unseal) | Auto-unseal Vault using the appropriate key set |
| 3 | [**KV**](#stage-3-enable-kv-secrets-engine) | Enable the [KV v2](https://developer.hashicorp.com/vault/docs/secrets/kv/kv-v2) secrets engine at `secret/` |
| 4 | [**API**](#stage-4-api-tokens) | Provision external API tokens |
| 5 | [**CERTS**](#stage-5-tls-certificates) | Provision TLS certificate / key pairs |
| 6 | [**CREDS**](#stage-6-application-database-credentials) | Provision application and database credentials |
| 7 | [**DONE**](#stage-7-final-message) | Final message — credential display (first run) or confirmation (re-run) |
...
[Seal/Unseal concept](https://developer.hashicorp.com/vault/docs/concepts/seal) ·
...
[Ansible Vault encryption](https://docs.ansible.com/ansible/latest/vault_guide/index.html) ·
[Project repository on GitHub](https://github.com/lukaszFD/cyber-sentinel)